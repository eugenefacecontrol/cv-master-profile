...
For **Link Group (AI-assisted QA) - QA Engineer AI-assisted**, the relevant focus is AI-assisted QA workflows, Playwright/Cypress/Pytest automation, web app user flows, CI/CD and UAT support. I bring a pragmatic automation mindset: build checks that give useful release signal, keep diagnostics readable, and connect test automation with developer feedback, CI/CD, logs, API/data validation, and product risk.
...
**Role-relevant stack:** Playwright, Cypress, Pytest, Claude Code, Cursor, CI/CD, UAT, web applications, access-control testing  
