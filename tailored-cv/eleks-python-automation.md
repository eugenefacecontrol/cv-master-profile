...
For **ELEKS - Senior Test Automation Engineer (Python)**, the relevant focus is Senior test automation with Python/Selenium/Jenkins, remote Krakow context, SQL nice-to-have. I bring a pragmatic automation mindset: build checks that give useful release signal, keep diagnostics readable, and connect test automation with developer feedback, CI/CD, logs, API/data validation, and product risk.
...
**Role-relevant stack:** Python, Selenium, Jenkins, JavaScript, SQL, automated testing  
