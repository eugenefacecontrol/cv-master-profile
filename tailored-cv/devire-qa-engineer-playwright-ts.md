...
For **Devire - QA Engineer**, the relevant focus is remote QA role with Playwright TS/JS, API testing, CI/CD, data quality and event-driven integrations. I bring a pragmatic automation mindset: build checks that give useful release signal, keep diagnostics readable, and connect test automation with developer feedback, CI/CD, logs, API/data validation, and product risk.
...
**Role-relevant stack:** Playwright TS/JS, Postman, GitLab CI/CD, K6, SQL, Kafka, RabbitMQ, Pact, API testing  
