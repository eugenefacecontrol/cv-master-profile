...
For **Grid Dynamics Poland - QA Automation Engineer with Python**, the relevant focus is Python-supported QA automation, Pytest/Playwright, REST API validation, SQL checks and EST-aligned Agile collaboration. I bring a pragmatic automation mindset: build checks that give useful release signal, keep diagnostics readable, and connect test automation with developer feedback, CI/CD, logs, API/data validation, and product risk.
...
**Role-relevant stack:** Python scripting, Pytest, Playwright, REST API, SQL/MySQL, CI/CD, Jira, test design  
