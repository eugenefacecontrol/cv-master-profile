# Tailored CV — Intellias

**Target company:** Intellias  
**Tier:** A  
**Priority rank:** TBD  
**Open roles count:** 1  
**Focus:** Senior Automation QA Engineer with leadership experience

---

## Tailoring notes
- Emphasize Playwright, TypeScript/JavaScript, API testing, E2E automation, CI/CD, Scrum, AI-assisted automation, and framework ownership.
- Position leadership honestly as technical ownership, mentoring, onboarding, and team enablement rather than formal people management.
- Mention cloud, Docker, Kubernetes, monitoring/reporting, SQL/NoSQL as practical or adjacent experience where appropriate.
...
Senior QA Automation Engineer / SDET focused on Playwright-based UI/API automation, E2E coverage, CI/CD-integrated testing, framework improvement, and practical technical leadership in Scrum teams.
...
Senior QA Automation Engineer with 7+ years of experience across UI/API automation, E2E testing, CI/CD quality workflows, framework improvement, and DevOps-aligned QA. Strong fit for Intellias' Digital Eco System context: Playwright, TypeScript/JavaScript, API testing, test data thinking, CI/CD automation, Scrum collaboration, AI-assisted workflows, and continuous improvement of tooling and processes.

Yauheni is strongest in roles where automation is treated as an engineering discipline: building maintainable test coverage, improving framework reliability, debugging failures, reporting test results clearly, and helping teams adopt better practices. His leadership fit is technical: mentoring, onboarding, explaining systems, improving workflows, and taking ownership of quality decisions without over-positioning as a formal people manager.

## Core Strengths

- 7+ years in QA automation and quality engineering
- Playwright automation and TypeScript / JavaScript
- UI and API automation for web applications
- E2E test coverage and regression strategy
- Test automation framework improvement and maintenance
- CI/CD-integrated automated test execution
- Test data management mindset for API/E2E scenarios
- AI-assisted automation workflow experience
- Scrum collaboration with developers and product teams
- Technical mentoring, onboarding, and team enablement
- Debugging, test reporting, and failure analysis
- Shift-left and continuous-improvement mindset
...
- Test runners ecosystem awareness
- Mocha / Jest ecosystem awareness
- Test reports and automation diagnostics
- AI-assisted engineering tools
- Docker
- Kubernetes
- Azure
- Cloud services awareness
- Monitoring/reporting tool awareness
- SQL / NoSQL test data setup awareness
- Bash
- Windows / Linux
- Agile / Scrum
- Power Automate
...
- Built the base for maintainable UI automation and regression testing
...
- Supported complex enterprise workflows where quality depended on automation, environments, delivery pipelines, and product context
...
- Senior QA Automation Engineer with strong Playwright/TypeScript/API/CI/CD fit
- Technical leadership through ownership, mentoring, onboarding, and process improvement
- Strongest in practical automation engineering, framework improvement, and workflow optimization

### Avoid overclaiming
- Do not position as formal people manager
- Do not claim deep Mocha/Jest ownership unless asked; frame as adjacent test-runner ecosystem awareness
- Cloud/Docker/Kubernetes are practical support/growth areas, not platform-architecture ownership from scratch
