...
For Yonder Media Mobile: web/API automation, Selenium/Playwright/Cypress-aligned experience, Postman/REST API testing, AI-assisted QA workflow interest, custom internal tools, and diagnostic judgment. Mobile/Appium and deeper Python automation are honest ramp-up areas.

---

## Core Strengths

- QA automation strategy and framework improvement
- UI/API testing and exploratory coverage
- Selenium foundation and Playwright/TypeScript direction
- Postman/Newman and REST API validation
- CI/CD-integrated quality workflows
- Defect triage, logs, and root-cause investigation
- Practical scripting and internal tool creation
- AI-assisted workflow and test generation awareness
- Test planning, risk analysis, and release support
- Remote collaboration with product/engineering teams

---

## Technical Skills

**Automation:** Playwright, Selenium WebDriver, API automation, Postman/Newman, Cypress/Appium ramp-up readiness  
...
**Testing:** UI/API, regression, smoke, exploratory, performance testing awareness  
