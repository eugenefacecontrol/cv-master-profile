...
Senior QA Automation Engineer with 7+ years of experience across manual and automated QA, backend/API validation, Java/C# automation foundations, SQL diagnostics, CI/CD workflows, and cross-team defect investigation.

Relevant to CAT Digital through backend service testing, Java automation foundation, API/database validation, Linux and PostgreSQL/MySQL readiness, Azure DevOps-style collaboration, and B2B remote-team communication.

---

## Core Strengths

- Backend service and API testing
- Java automation foundation and Selenium experience
- Manual investigation plus automation delivery
- SQL/PostgreSQL/MySQL validation readiness
- CI/CD pipeline support and test environment diagnostics
- Agile/Scrum collaboration and clear defect reporting
- Distributed-service testing mindset
- Russian/English remote-team communication

---

## Technical Skills

**Automation:** Selenium WebDriver, API automation, Postman/Newman, Playwright direction, Karate/JUnit ramp-up  
**Languages:** Java, C#, TypeScript/JavaScript, PowerShell, SQL, practical Python scripting  
**CI/CD:** Jenkins, TeamCity, Azure DevOps/AZDO, GitLab CI readiness, YAML pipelines, Git  
**Backend/Data:** REST API, SQL, PostgreSQL/MySQL readiness, Linux/log diagnostics  
**Quality Scope:** Manual + automation, backend, integration, regression, exploratory testing
