...
For **INDG | Grip - QA Automation Engineer (C#/TS)**, the relevant focus is C#/TypeScript QA automation for a product platform, web automation, framework maintainability. I bring a pragmatic automation mindset: build checks that give useful release signal, keep diagnostics readable, and connect test automation with developer feedback, CI/CD, logs, API/data validation, and product risk.
...
**Role-relevant stack:** C#, TypeScript, QA automation, visual product platform, web automation  
