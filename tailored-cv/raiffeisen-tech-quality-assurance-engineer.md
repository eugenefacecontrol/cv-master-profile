...
For **Raiffeisen Tech Poland - Quality Assurance Engineer**, the relevant focus is banking QA role with automation potential; exact stack needs verification from LinkedIn/full JD. I bring a pragmatic automation mindset: build checks that give useful release signal, keep diagnostics readable, and connect test automation with developer feedback, CI/CD, logs, API/data validation, and product risk.
...
**Role-relevant stack:** QA, banking, API/UI testing, CI/CD-aware quality, SQL/log diagnostics  
