...
- Product QA ownership and test strategy
- Playwright and TypeScript automation direction
- Frontend, backend, API, smoke, and regression testing
- Exploratory testing and defect investigation
- CI/CD-integrated quality feedback
- Test plans, acceptance criteria, and release confidence
- Framework improvement and maintainable automation
- Logs, DevTools, SQL, and backend investigation
- Cross-functional collaboration in Agile teams
- Clear documentation and risk-focused QA communication

---

## Technical Skills

**Automation:** Playwright, Selenium WebDriver, API automation, Postman/Newman, test framework improvement  
...
**Testing:** UI/API, E2E, smoke, regression, exploratory, acceptance testing, non-functional awareness  
**Debugging:** Browser DevTools, logs, SQL, environment troubleshooting, defect triage
