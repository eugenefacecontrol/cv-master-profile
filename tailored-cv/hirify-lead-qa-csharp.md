...
Relevant to the Lead QA Engineer role through C#/.NET automation background, Selenium and Playwright direction, API quality ownership, CI/CD feedback loops, SQL-backed diagnostics, non-functional testing awareness, and mentoring/onboarding experience.
...
- C#/.NET and Java automation foundation
- Playwright/Selenium UI automation direction
- REST API testing and backend validation
- CI/CD-integrated regression and quality gates
- SQL-based test data and defect analysis
- Test planning, risk analysis, and QA documentation
- Mentoring, onboarding, and cross-team quality communication

---

## Technical Skills

**Automation:** Playwright direction, Selenium WebDriver, API automation, Postman/Newman, NUnit, TestRail  
...
**Data/Diagnostics:** PostgreSQL/SQL, logs, Browser DevTools, environment investigation  
**Quality Scope:** Functional, integration, regression, exploratory, and performance testing awareness
