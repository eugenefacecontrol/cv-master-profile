...
For **co.brick - Senior QA Automation Engineer (Playwright / TypeScript)**, the relevant focus is Playwright and TypeScript automation, UI/API coverage, CI/CD feedback, maintainable web-product testing and senior QA ownership. I bring a pragmatic automation mindset: build checks that give useful release signal, keep diagnostics readable, and connect test automation with developer feedback, CI/CD, logs, API/data validation, and product risk.
...
**Role-relevant stack:** Playwright, TypeScript, QA automation  
