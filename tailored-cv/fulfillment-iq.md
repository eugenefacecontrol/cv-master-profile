...
- SDET-style automation framework improvement
- UI and API automation coverage
- Playwright automation direction
- REST API testing and backend validation
- SQL/PostgreSQL investigation and test data support
- Azure DevOps, YAML pipelines, and CI/CD workflows
- Exploratory testing and complex scenario validation
- Defect triage, logs, and root-cause investigation
- Agile collaboration with developers/product stakeholders
- Practical Python scripting and fast tool ramp-up

---

## Technical Skills

**Automation:** Playwright, Selenium WebDriver, API automation, Postman/Newman, Pytest ramp-up readiness  
...
**Data/Backend:** PostgreSQL, SQL validation, REST APIs, backend investigation  
**Debugging:** Browser DevTools, logs, defect triage, environment investigation
