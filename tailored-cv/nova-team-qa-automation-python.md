# Yauheni Sheima
## QA Automation Engineer - Python / Backend
...
Senior QA Automation Engineer with 7+ years of experience across API automation, backend validation, CI/CD-integrated regression, test framework improvement, manual investigation, and production-like diagnostics.

Relevant to the Nova Team fintech/crypto role through Python scripting readiness, backend/API testing, framework maintenance, logs and metrics analysis, SQL validation, Linux/CLI comfort, and high-load/payment-domain readiness.

---

## Core Strengths

- Backend and API automation focus
- Python scripting and pytest ramp-up readiness
- Framework maintenance and code review awareness
- Manual investigation for debugging and exploratory QA
- SQL, logs, metrics, and Linux/CLI diagnostics
- CI/CD and TestOps-oriented quality feedback
- Fintech/crypto/payment systems readiness
- Risk analysis and complex scenario coverage

---

## Technical Skills

**Automation:** API automation, Playwright direction, Selenium WebDriver, Postman/Newman, pytest ramp-up  
**Languages:** Python scripting, TypeScript/JavaScript, C#, Java, PowerShell, SQL  
**CI/CD/Infra:** Jenkins, TeamCity, Azure DevOps, Git, Docker/Linux context, YAML pipelines  
**Diagnostics:** Logs, metrics/Grafana context, SQL, Browser DevTools, environment investigation  
**Testing:** Backend/API, integration, regression, exploratory, load/performance awareness
