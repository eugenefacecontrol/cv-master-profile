# Yauheni Sheima
## QA Engineer - Fintech / AI Automation
...
Senior QA Automation Engineer with 7+ years of experience across manual and automated QA, API testing, CI/CD-integrated regression, test strategy, and automation framework improvement.

Relevant to this fintech QA role through Playwright/Cypress/Selenium direction, JavaScript/TypeScript/Python scripting readiness, SQL-backed validation, Jira-driven delivery, AI-assisted QA experimentation, and ownership of practical test processes.

---

## Core Strengths

- Manual + automation QA in Agile teams
- Playwright/Cypress/Selenium automation direction
- API testing, SQL validation, and backend diagnostics
- CI/CD exposure and automated regression feedback
- AI-assisted testing and test data/scenario generation
- Risk-based testing and clear test planning
- Jira-based defect tracking and communication
- Fintech/payments readiness and product-quality ownership

---

## Technical Skills

**Automation:** Playwright direction, Selenium WebDriver, API automation, Postman/Newman, Cypress ramp-up, TestRail  
**Languages:** TypeScript/JavaScript, C#, Java, SQL, PowerShell, practical Python scripting  
**CI/CD:** Jenkins, TeamCity, Azure DevOps, GitLab CI readiness, YAML pipelines, Git  
**Testing:** Functional, regression, exploratory, integration, API, and performance/security awareness  
**Tools:** Jira, Browser DevTools, logs, SQL, AI-assisted workflows
