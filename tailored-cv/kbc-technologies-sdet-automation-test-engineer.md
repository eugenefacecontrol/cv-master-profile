...
For **KBC Technologies Group - SDET (Automation Test Engineer)**, the relevant focus is SDET/Automation Test Engineer work, UI/API automation, CI/CD-integrated checks, defect diagnostics, and pragmatic test framework maintenance. I bring a pragmatic automation mindset: build checks that give useful release signal, keep diagnostics readable, and connect test automation with developer feedback, CI/CD, logs, API/data validation, and product risk.
...
**Role-relevant stack:** SDET, test automation, contract, Krakow  
