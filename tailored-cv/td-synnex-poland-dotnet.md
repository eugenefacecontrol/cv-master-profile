...
For **TD SYNNEX Poland - Senior Test Automation Engineer (.NET)**, the relevant focus is .NET/C# automation foundation, senior QA automation, CI/CD feedback, enterprise product quality. I bring a pragmatic automation mindset: build checks that give useful release signal, keep diagnostics readable, and connect test automation with developer feedback, CI/CD, logs, API/data validation, and product risk.
...
**Role-relevant stack:** .NET, C#, test automation, CI/CD, SDET  
