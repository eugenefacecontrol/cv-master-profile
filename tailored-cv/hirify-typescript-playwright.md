...
- JavaScript/TypeScript, C#, Java, PowerShell, SQL
- REST API testing and backend validation
- Functional, integration, contract, and performance testing awareness
- CI/CD pipelines and automated feedback loops
- BDD/TDD-aware acceptance criteria collaboration
- Coaching/onboarding and knowledge sharing
...
**Cloud/Infra Context:** Azure, Docker, Kubernetes support scenarios, AWS ramp-up readiness  
**Debugging:** Browser DevTools, logs, SQL, environment investigation, Jira
