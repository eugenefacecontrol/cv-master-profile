...
Senior QA Automation Engineer with 7+ years of experience across web QA, UI/API automation, backend validation, CI/CD workflows, test documentation, and framework improvement.

Relevant to ROGII through TypeScript/Playwright direction, frontend and backend testing, API/microservice validation, DevTools/Jira diagnostics, regression ownership, and practical AI-assisted QA workflows.

---

## Core Strengths

- Fullstack web QA across frontend and backend services
- Playwright and TypeScript automation direction
- REST API and integration testing
- Microservice and backend validation mindset
- CI/CD quality workflows and regression stability
- DevTools, logs, Jira, and defect evidence
- Test design, documentation, and QA process improvement
- AI-assisted test generation and debugging workflows
...
**Backend/Debugging:** REST API, SQL, Browser DevTools, logs, microservice testing context  
**Quality Scope:** Web, API, integration, regression, exploratory testing
