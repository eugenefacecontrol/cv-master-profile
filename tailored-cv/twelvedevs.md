...
For **Twelvedevs - Middle AQA Engineer (JS/TS Playwright)**, the relevant focus is Playwright, TypeScript/JavaScript, UI/API/integration testing, AI tools in QA, CI/CD understanding, and product automation ownership. I bring a pragmatic automation mindset: build checks that give useful release signal, keep diagnostics readable, and connect test automation with developer feedback, CI/CD, logs, API/data validation, and product risk.
...
**Role-relevant stack:** Playwright, TypeScript, JS, UI/API/Integration Testing, AI tools in QA, CI/CD  
