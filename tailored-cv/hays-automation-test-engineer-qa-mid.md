...
For **Hays - Automation Test Engineer / QA Mid level**, the relevant focus is banking QA automation contract with incomplete public LinkedIn JD; recruiter and full stack need verification. I bring a pragmatic automation mindset: build checks that give useful release signal, keep diagnostics readable, and connect test automation with developer feedback, CI/CD, logs, API/data validation, and product risk.
...
**Role-relevant stack:** QA automation, banking, API/UI testing, CI/CD, defect triage, contract work  
