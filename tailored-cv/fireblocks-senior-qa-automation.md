...
For **Fireblocks - Senior QA Automation Engineer**, the relevant focus is Senior QA automation for fintech/security products, API and frontend automation, CI/CD feedback, logs/observability, and quality ownership. I bring a pragmatic automation mindset: build checks that give useful release signal, keep diagnostics readable, and connect test automation with developer feedback, CI/CD, logs, API/data validation, and product risk.
...
**Role-relevant stack:** API/frontend automation, fintech/crypto, logs/Datadog/Sentry, AI agents, product-quality ownership  
