...
For **Diabolocom - Middle/Senior SDET - Full Remote**, the relevant focus is Full remote SDET role, quality strategy, distributed systems, CI/CD quality gates, Python/Java/Kotlin automation. I bring a pragmatic automation mindset: build checks that give useful release signal, keep diagnostics readable, and connect test automation with developer feedback, CI/CD, logs, API/data validation, and product risk.
...
**Role-relevant stack:** SDET, Java/Kotlin or Python, CI/CD, quality gates, distributed architecture  
