...
For **Antal (IoT API) - QA Automation Engineer**, the relevant focus is API automation for IoT services, TypeScript/Node.js test work, databases, Docker and CI/CD pipelines. I bring a pragmatic automation mindset: build checks that give useful release signal, keep diagnostics readable, and connect test automation with developer feedback, CI/CD, logs, API/data validation, and product risk.
...
**Role-relevant stack:** JavaScript/TypeScript, Node.js, REST API, PostgreSQL, MongoDB, Docker, GitLab/GitHub Actions  
