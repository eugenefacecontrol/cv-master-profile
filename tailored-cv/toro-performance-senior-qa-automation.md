...
For **Toro Performance - Senior QA Automation Engineer**, the relevant focus is Senior QA automation, Playwright, API testing, mocking/stubbing, microservice-style validation, and automation framework ownership. I bring a pragmatic automation mindset: build checks that give useful release signal, keep diagnostics readable, and connect test automation with developer feedback, CI/CD, logs, API/data validation, and product risk.
...
**Role-relevant stack:** Playwright, API testing, mocking/stubbing, microservices, automation frameworks  
