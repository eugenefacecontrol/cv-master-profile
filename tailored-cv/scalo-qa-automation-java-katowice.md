...
For **SCALO (QA Automation Java Katowice) - QA/Automation Tester (Java)**, the relevant focus is Java-oriented QA automation, REST Assured/API testing, Selenium or Playwright UI checks, SQL, Azure DevOps, BDD, and banking workflow quality. I bring a pragmatic automation mindset: build checks that give useful release signal, keep diagnostics readable, and connect test automation with developer feedback, CI/CD, logs, API/data validation, and product risk.
...
**Role-relevant stack:** Java, REST Assured, Selenium/Playwright, TypeScript, Cucumber/JBehave, SQL, Postman/Bruno, Azure DevOps, banking workflows  
