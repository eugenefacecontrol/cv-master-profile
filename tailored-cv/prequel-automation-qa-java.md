...
Senior QA Automation Engineer with 7+ years of QA experience across UI/API automation, Java/C# automation foundations, CI/CD support, framework maintenance, and defect analysis.

Relevant to Prequel through Java automation background, API and mobile/web E2E testing readiness, Selenium/Selenide/Appium ramp-up, GitLab CI/CD fit, flaky-test investigation, and practical AI-assisted engineering workflows.
...
- API and web/mobile E2E testing readiness
- Framework maintenance and flaky-test analysis
- CI/CD pipeline support and quality feedback
- Manual investigation plus automation delivery
- Backend validation and REST API testing
- AI-assisted engineering workflow awareness
- Clear defect evidence and root-cause analysis

---

## Technical Skills

**Automation:** Selenium WebDriver, Playwright direction, API automation, Postman/Newman, Appium/Selenide ramp-up  
**Languages:** Java, C#, TypeScript/JavaScript, PowerShell, SQL, practical Python scripting  
**CI/CD:** GitLab CI readiness, Jenkins, TeamCity, Azure DevOps, YAML pipelines, Git  
**Diagnostics:** Logs, SQL, Browser DevTools, environment investigation  
**Quality Scope:** API, web, mobile E2E readiness, regression, integration, exploratory testing
