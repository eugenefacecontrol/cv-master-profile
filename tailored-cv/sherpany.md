# Tailored CV — SHERPANY

**Target company:** SHERPANY  
**Tier:** A  
**Priority rank:** TBD  
**Open roles count:** 1  
**Focus:** Senior QA Engineer — remote product quality / meeting management platform

---

## Tailoring notes
- Emphasize Playwright, TypeScript, REST/API testing, CI/CD, Docker/Kubernetes context, quality reporting, and autonomous product-quality ownership.
- Position Python as scripting-adjacent and LLM/performance testing as growth/adjacent areas unless asked directly.
- Focus on product quality, quality awareness, customer satisfaction, and continuous improvement.
...
Yauheni Sheima is an automation-focused engineer with a background spanning QA Automation, DevOps-aligned infrastructure work, pipeline-driven delivery, and internal tooling.
...
- Product-quality ownership and continuous improvement
- UI and API automation for web applications
- Playwright and TypeScript / JavaScript automation
- REST API testing and framework improvement
- Manual and automated testing balance
- Quality reporting and test-result analysis
- CI/CD-integrated test execution
- Docker / Kubernetes support context
- Analytical debugging and deficiency identification
- Agile collaboration and autonomous delivery
- Quality-awareness mindset across the team
- Customer-satisfaction-oriented testing
...
- LLM testing awareness
- Python scripting basics
- Quality reports / management reporting
- Quality planning and test strategy
- Test data and KPI analysis mindset
- Agile methodologies
- Bash
- Windows / Linux
- Grafana
...
- Senior QA Engineer with strong Playwright/TypeScript/API/CI/CD/product-quality fit
- Strongest in practical automation engineering, quality feedback, and workflow improvement
- Good match for autonomous remote product teams

### Avoid overclaiming
- Do not claim deep LLM testing ownership; frame as awareness/growth area
- Do not position performance testing as deepest specialization
- Python is practical scripting-adjacent, not current strongest primary stack
