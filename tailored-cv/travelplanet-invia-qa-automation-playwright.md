...
For **Travelplanet.pl / Invia Group - QA Automation Engineer**, the relevant focus is Playwright automation, REST API testing, CI/CD, BrowserStack-style cross-browser validation, and web/backend quality for travel products. I bring a pragmatic automation mindset: build checks that give useful release signal, keep diagnostics readable, and connect test automation with developer feedback, CI/CD, logs, API/data validation, and product risk.
...
**Role-relevant stack:** Playwright, REST, CI/CD, BrowserStack, web/backend testing  
