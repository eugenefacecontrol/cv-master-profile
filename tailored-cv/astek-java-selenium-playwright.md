...
For **Astek Polska - Tester Automatyzujacy / Testerka Automatyzujaca Java Selenium Playwright**, the relevant focus is Java/Selenium/Playwright automation, REST Assured API checks, SQL validation and Azure DevOps pipelines. I bring a pragmatic automation mindset: build checks that give useful release signal, keep diagnostics readable, and connect test automation with developer feedback, CI/CD, logs, API/data validation, and product risk.
...
**Role-relevant stack:** Java, Selenium, Playwright, SQL, Azure DevOps, REST Assured, Cucumber/JBehave, CI/CD  
