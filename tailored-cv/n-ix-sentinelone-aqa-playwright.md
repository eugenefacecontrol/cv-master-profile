...
For **N-iX / SentinelOne - Senior AQA Engineer (Playwright)**, the relevant focus is Playwright and TypeScript automation for cybersecurity SaaS, API/E2E/backend test coverage, defect triage and CI feedback. I bring a pragmatic automation mindset: build checks that give useful release signal, keep diagnostics readable, and connect test automation with developer feedback, CI/CD, logs, API/data validation, and product risk.
...
**Role-relevant stack:** TypeScript, Playwright, REST API testing, E2E testing, backend/infrastructure testing, CI/CD, log analysis  
