...
For **inFakt - QA Engineer (Playwright)**, the relevant focus is Playwright automation, TypeScript/JavaScript, API testing, CI/CD/GitHub Actions, AI-assisted QA tools, and product-quality ownership. I bring a pragmatic automation mindset: build checks that give useful release signal, keep diagnostics readable, and connect test automation with developer feedback, CI/CD, logs, API/data validation, and product risk.
...
**Role-relevant stack:** Playwright, TypeScript/JavaScript, API testing, CI/CD, GitHub Actions, AI tools  
