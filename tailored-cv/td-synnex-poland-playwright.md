...
For **TD SYNNEX Poland - Senior Software Engineer in Test - Playwright**, the relevant focus is Software Engineer in Test role with Playwright, automation design, CI/CD feedback, diagnostics. I bring a pragmatic automation mindset: build checks that give useful release signal, keep diagnostics readable, and connect test automation with developer feedback, CI/CD, logs, API/data validation, and product risk.
...
**Role-relevant stack:** Playwright, TypeScript/JavaScript, SDET, CI/CD, test architecture  
