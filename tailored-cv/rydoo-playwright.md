...
For **Rydoo - Senior Automation QA Engineer (Playwright)**, the relevant focus is Senior Playwright automation, product QA, maintainable UI/API coverage, release feedback. I bring a pragmatic automation mindset: build checks that give useful release signal, keep diagnostics readable, and connect test automation with developer feedback, CI/CD, logs, API/data validation, and product risk.
...
**Role-relevant stack:** Playwright, TypeScript/JavaScript, UI/API automation, CI/CD  
