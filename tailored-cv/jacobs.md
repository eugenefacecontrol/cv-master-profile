...
**Target company:** Jacobs  
**Tier:** A  
**Priority rank:** TBD  
**Open roles count:** 1  
**Focus:** Senior QA Automation Engineer — Health Data Platforms

---

## Tailoring notes
- Emphasize Playwright/API/UI automation, TypeScript/JavaScript, CI/CD with GitHub Actions/Azure DevOps, BDD, SQL, Bash, manual/exploratory testing, and healthcare data-platform quality.
- Prioritize cloud-based Health Data Platforms, clinical data processing, regulatory/research stakeholders, and collaboration with product/development teams.
- Mention Python honestly as adjacent scripting/automation capability rather than strongest current stack.
...
Senior QA Automation Engineer / SDET focused on reliable web application quality, API/UI automation, CI/CD-integrated testing, and practical QA ownership for data-heavy product platforms.
...
Senior QA Automation Engineer with 7+ years of experience across UI/API automation, manual and exploratory testing, test planning, regression coverage, and CI/CD-integrated quality workflows. Strong fit for teams building cloud-based Health Data Platforms that need reliable automated tests, clear QA lifecycle ownership, and close collaboration with developers and product teams.

Yauheni has hands-on strengths in Playwright, TypeScript/JavaScript, REST API framework improvement, Selenium foundations, CI/CD pipelines, SQL/database validation, Bash/PowerShell scripting, and environment-aware debugging. His experience with enterprise workflows, careful validation, and test-signal improvement is relevant to healthcare and clinical data platforms where data correctness, reliability, and stakeholder trust matter.
...
- Senior ownership of test planning, test design, and QA lifecycle
- Playwright automation for web applications
- API and UI test automation
- TypeScript / JavaScript automation experience
- BDD / Cucumber-style scenario thinking
- Functional, regression, exploratory, and manual testing
- SQL validation in test environments
- Shell/Bash and PowerShell workflow automation
- CI/CD integration with Azure DevOps/GitHub-style pipelines
- Collaboration with developers and product teams
- Healthcare data-platform and regulatory-stakeholder adaptability
...
- Health Data Platform adaptability
- Clinical data workflow awareness
- Regulatory / research stakeholder context
- QA lifecycle ownership
...
- Structured manual and automated validation in enterprise delivery
...
- Built a foundation for maintainable UI automation and regression testing
...
- Worked with complex enterprise workflows where issue investigation often required understanding product state, environments, logs, and data conditions
...
- Relevant mindset for healthcare data platforms where correctness, traceability, and careful workflow validation matter
