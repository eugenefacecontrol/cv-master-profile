...
Senior QA Engineer with 7+ years of experience across manual QA, API/UI automation, regression testing, test documentation, CI/CD support, and practical automation tooling.

Relevant to Actimind through web and mobile QA readiness, backend/API validation, gradual automation growth with Python/Playwright direction, load-testing awareness, SQL/log diagnostics, and pragmatic use of AI tools for testing support.

---

## Core Strengths

- Manual web, mobile, backend, and regression testing
- API testing and backend validation
- Python scripting readiness and Playwright direction
- Test cases, checklists, and QA documentation
- Regression planning and defect lifecycle ownership
- SQL, DevTools, logs, and environment diagnostics
- Load/performance testing awareness
- AI-assisted test scenario and documentation workflows

---

## Technical Skills

**Automation:** Playwright direction, Selenium WebDriver, API automation, Postman/Newman, TestRail  
**Languages:** Python scripting, TypeScript/JavaScript, C#, Java, PowerShell, SQL  
**CI/CD/Infra:** Jenkins, TeamCity, Azure DevOps, Git, Docker context, YAML pipelines  
**Testing:** Functional, regression, integration, exploratory, API, and performance testing awareness  
**Tools:** Jira, Confluence-style documentation, Browser DevTools, logs
