# Tailored CV — ALTEN Polska

**Target company:** ALTEN Polska  
**Tier:** A  
**Priority rank:** TBD  
**Open roles count:** 1  
**Focus:** Automation Test Engineer — Payments platforms

---

## Tailoring notes
- Emphasize Java/Selenium automation foundation, API/service-level testing, CI/CD quality gates, logs/database diagnostics, and payments-adjacent enterprise workflow context.
- Prioritize maintainable automation, regression reduction, release confidence, traceability, and end-to-end validation.
- Position payments/ISO 20022/SWIFT as relevant banking-style workflow exposure and fast ramp-up area, not deep specialist ownership.
...
- Contract/schema validation awareness
- JUnit / TestNG ecosystem familiarity
- Maven / Gradle ecosystem familiarity
- REST Assured / SoapUI awareness
- JMeter awareness
- Python scripting basics
- Payment flows / processing lifecycle adaptability
- Credit transfers / direct debits awareness
- Payment gateways, validation, routing, and posting awareness
- Returns, recalls, reversals, rejects, repairs, and exception-handling awareness
- Cut-off times, value dates, fees, limits, and sanctions/AML touchpoint awareness
- SWIFT / ISO 20022 awareness
- Test data strategy and transaction correlation mindset
- Quality gates / execution reporting
- Automation coverage dashboards and metrics
- Splunk / ELK-style observability awareness
- Docker
- Kubernetes
- Bash
- Agile / Scrum
