...
For **Catawiki - QA Automation Engineer**, the relevant focus is Web/mobile/API E2E automation with Playwright and cross-platform quality. I bring a pragmatic automation mindset: build checks that give useful release signal, keep diagnostics readable, and connect test automation with developer feedback, CI/CD, logs, API/data validation, and product risk.
...
**Role-relevant stack:** Playwright, API testing, web/mobile automation, E2E testing  
