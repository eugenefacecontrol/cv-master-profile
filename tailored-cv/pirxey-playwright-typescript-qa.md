...
For **Pirxey - QA Automation Engineer (Playwright & TypeScript)**, the relevant focus is Playwright, TypeScript, Node.js context, API/UI automation, GitHub Actions, AI CLI tools, and compact product-team QA ownership. I bring a pragmatic automation mindset: build checks that give useful release signal, keep diagnostics readable, and connect test automation with developer feedback, CI/CD, logs, API/data validation, and product risk.
...
**Role-relevant stack:** Playwright, TypeScript, Node.js, GitHub Actions, API testing, AI CLI tools  
