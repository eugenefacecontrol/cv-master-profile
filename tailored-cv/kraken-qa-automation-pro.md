...
For **Kraken - QA Automation Engineer - Pro**, the relevant focus is crypto trading backend, market data, matching engine services, API quality, backend diagnostics and remote product engineering. I bring a pragmatic automation mindset: build checks that give useful release signal, keep diagnostics readable, and connect test automation with developer feedback, CI/CD, logs, API/data validation, and product risk.
...
**Role-relevant stack:** API testing, backend validation, trading systems, CI/CD, logs, SQL, Playwright/Selenium foundation, practical Python scripting  
